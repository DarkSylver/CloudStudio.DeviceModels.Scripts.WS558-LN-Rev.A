...
function getEndpoints(deviceAddress, endpoints) {
    ...
    endpoints.addEndpoint("2", "Active Power", endpointType.activePowerSensor);
    endpoints.addEndpoint("3", "Power Factor", endpointType.cosPhiSensor);
    endpoints.addEndpoint("4", "Total Current", endpointType.currentSensor);
    endpoints.addEndpoint("5", "Power Consumption", endpointType.energyMeter);
