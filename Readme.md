...
# Parsing + Configuration Script – WS558 - LN - Rev. A

This **Parsing + Configuration** script is designed for the **WS558 - LN** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – WS558 - LN Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **WS558 - LN** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
